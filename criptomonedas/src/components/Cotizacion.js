...
const Cotizacion = ({resultado}) => {
    ...
    return (  
        <ResultadoDiv>
            ...
            <Info>Variacion ultimas 24 horas: <span>{resultado.CHANGE24HOUR}</span></Info>
            <Info>Porcentaje de variacion ultimas 24 horas: <span>{resultado.CHANGEPCT24HOUR}%</span></Info>
