...
const Dropzone = () => {
    ...
    return (  
        <div className = "md:flex-1 mb-3 mx-2 mt-16 lg:mt-0 flex flex-col items-center items-center justify-center border-dashed border-gray-400 border-2 bg-gray-100 px-4">
            {
                ...
                ? (
                    <div className = "mt-10 w-full">
                        ...
                        <button
                            type = "button"
                            className = "bg-blue-700 w-full py-3 rounded-lg text-white my-10 hover:bg-blue800"
                            onClick = { () => crearEnlace() }
                        >Crear enlace</button>
                    </div>
                )
                        ...
                        />
                            {
                                ...
                                <div className = "text-center">
                                    ...
                                    <button className = "bg-blue-700 w-full py-3 rounded-lg text-white my-10 hover:bg-blue800" type = "button">
